	...
	<header class="comment__meta">
		...
		<?php Hybrid\Comment\display_permalink( [
			'text' => sprintf(
				...
				esc_html__( '%1$s at %2$s', 'strangebrew' ),
				Hybrid\Comment\render_date(),
				Hybrid\Comment\render_time()
			)
		] ) ?>
		<?php Hybrid\Comment\display_edit_link( [ 'before' => Strangebrew\sep() ] ) ?>
		<?php Hybrid\Comment\display_reply_link( [ 'before' => Strangebrew\sep() ] ) ?>
	</header>
	...
	<div class="comment__content">
		...
		<?php if ( ! Hybrid\Comment\is_approved() ) : ?>
			...
			<p class="comment__moderation">
				<?php esc_html_e( 'Your comment is awaiting moderation.', 'strangebrew' ) ?>
			</p>
